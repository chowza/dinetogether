...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsStoreStoreJs = __webpack_require__(175);

	var _jsStoreStoreJs2 = _interopRequireDefault(_jsStoreStoreJs);

	var _reactRouter = __webpack_require__(188);

	var _reactRouter2 = _interopRequireDefault(_reactRouter);

	var _jsContainersMealsTableJs = __webpack_require__(227);

	var _jsContainersMealsTableJs2 = _interopRequireDefault(_jsContainersMealsTableJs);

	var _jsContainersContactsTableJs = __webpack_require__(237);

	var _jsContainersContactsTableJs2 = _interopRequireDefault(_jsContainersContactsTableJs);

	var _jsContainersMessagesTableJs = __webpack_require__(240);

	var _jsContainersMessagesTableJs2 = _interopRequireDefault(_jsContainersMessagesTableJs);

	var _jsContainersMenuContainerJs = __webpack_require__(243);

	var _jsContainersMenuContainerJs2 = _interopRequireDefault(_jsContainersMenuContainerJs);

	var _jsComponentsNavHeaderJs = __webpack_require__(245);

	var _jsComponentsNavHeaderJs2 = _interopRequireDefault(_jsComponentsNavHeaderJs);
	...
	var routes = _react2['default'].createElement(
		...
		_react2['default'].createElement(DefaultRoute, { handler: _jsContainersMealsTableJs2['default'] }),
		_react2['default'].createElement(Route, { name: 'contactsTable', handler: _jsContainersContactsTableJs2['default'] }),
		_react2['default'].createElement(Route, { name: 'messagesTable', path: '/messagesTable/:chatId', handler: _jsContainersMessagesTableJs2['default'] })
	);
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					{ store: _jsStoreStoreJs2['default'] },
					function () {
						return _react2['default'].createElement(
							'div',
							null,
							_react2['default'].createElement(_jsComponentsNavHeaderJs2['default'], null),
							_react2['default'].createElement(_jsContainersMenuContainerJs2['default'], null)
						);
					}
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsReducersContactsReducer = __webpack_require__(176);

	var _jsReducersContactsReducer2 = _interopRequireDefault(_jsReducersContactsReducer);

	var _jsReducersMealsReducer = __webpack_require__(180);

	var _jsReducersMealsReducer2 = _interopRequireDefault(_jsReducersMealsReducer);

	var _jsReducersMenuReducer = __webpack_require__(181);

	var _jsReducersMenuReducer2 = _interopRequireDefault(_jsReducersMenuReducer);

	var _jsReducersMessagesReducer = __webpack_require__(182);

	var _jsReducersMessagesReducer2 = _interopRequireDefault(_jsReducersMessagesReducer);

	var _jsReducersProfileReducer = __webpack_require__(183);

	var _jsReducersProfileReducer2 = _interopRequireDefault(_jsReducersProfileReducer);
	...
	var reducer = (0, _redux.combineReducers)({ contactsReducer: _jsReducersContactsReducer2['default'], mealsReducer: _jsReducersMealsReducer2['default'], menuReducer: _jsReducersMenuReducer2['default'], messagesReducer: _jsReducersMessagesReducer2['default'], profileReducer: _jsReducersProfileReducer2['default'] });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsConstantsConstants = __webpack_require__(178);

	var _jsConstantsConstants2 = _interopRequireDefault(_jsConstantsConstants);

	var initialState = _immutable2['default'].Map({
		isFetching: true,
		didInvalidate: false,
		contacts: _immutable2['default'].List()
	});
	...
	function contactsReducer(state, action) {
		...
		switch (action.type) {
			case _jsConstantsConstants2['default'].REQUEST_CONTACTS:
				return _immutable2['default'].Map({
					isFetching: true,
					didInvalidate: false,
					contacts: state.get('contacts')
				});
			case _jsConstantsConstants2['default'].RECEIVE_CONTACTS:
				return _immutable2['default'].Map({
					isFetching: false,
					didInvalidate: false,
					contacts: _immutable2['default'].List(action.details.sort(sortByLastMessage))
				});
			case _jsConstantsConstants2['default'].INVALIDATE_CONTACTS:
...
/***/ function(module, exports, __webpack_require__) {
	...
	function mealsReducer(state, action) {
		...
		switch (action.type) {
			case _jsConstantsConstants2['default'].REQUEST_MEALS:
				return state.set(action.requestType, {
					isFetching: true,
					didInvalidate: false,
			...
			case _jsConstantsConstants2['default'].INVALIDATE_MEALS:
				return state.set(action.requestType, {
					isFetching: false,
					didInvalidate: true,
					items: state.get(action.requestType).items
				});
			case _jsConstantsConstants2['default'].RECEIVE_MEALS:
				return state.set(action.requestType, {
					isFetching: false,
					didInvalidate: false,
					items: _immutable2['default'].List(action.details.sort(sortByDistance))
				});
			case _jsConstantsConstants2['default'].JOIN_MEAL:
				return state.set(action.requestType, {
					isFetching: false,
					didInvalidate: false,
					items: state.get(action.requestType).items.push(action.details)
				});
			case _jsConstantsConstants2['default'].CREATE_MEAL:
				return _immutable2['default'].Map({
					allMeals: {
						isFetching: false,
						didInvalidate: false,
			...
			case _jsConstantsConstants2['default'].CANCEL_MEAL:
...
/***/ function(module, exports, __webpack_require__) {
	...
	function menuReducer(state, action) {
		...
		switch (action.type) {
			case _jsConstantsConstants2['default'].TOGGLE_MENU:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = _immutable2['default'].Map({
		noMessages: {
			messages: _immutable2['default'].List()
		}
	...
	function messagesReducer(state, action) {
		...
		switch (action.type) {
			case _jsConstantsConstants2['default'].REQUEST_MESSAGES:
				var contact = state.get(action.contactId) || state.get('noMessages');
				return state.set(action.contactId, {
					isFetching: true,
					didInvalidate: false,
					messages: contact.messages
				});
			case _jsConstantsConstants2['default'].RECEIVE_MESSAGES:
				return state.set(action.contactId, {
					isFetching: false,
					didInvalidate: false,
					messages: _immutable2['default'].List(action.details.sort(sortByLastMessage))
				});
			case _jsConstantsConstants2['default'].INVALIDATE_MESSAGES:
				return state.set(action.contactId, {
					isFetching: false,
					didInvalidate: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function profileReducer(state, action) {
		...
		switch (action.type) {
			case _jsConstantsConstants2['default'].REQUEST_PROFILE:
				var profile = state.get(action.profileId) || state.get('emptyProfile');
				return state.set(action.profileId, {
					isFetching: true,
					didInvalidate: false,
					data: profile.data
				});
			case _jsConstantsConstants2['default'].INVALIDATE_PROFILE:
				return state.set(action.profileId, {
					isFetching: false,
					didInvalidate: false,
					data: state.get(action.profileId).data
				});
			case _jsConstantsConstants2['default'].RECEIVE_PROFILE:
				return state.set(action.profileId, {
					isFetching: false,
					didInvalidate: false,
					data: _immutable2['default'].Map(action.details)
				});
			default:
				return state;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createLogger = __webpack_require__(186);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DefaultRoute = __webpack_require__(189);
	exports.Link = __webpack_require__(202);
	exports.NotFoundRoute = __webpack_require__(203);
	exports.Redirect = __webpack_require__(204);
	exports.Route = __webpack_require__(201);
	exports.ActiveHandler = __webpack_require__(199);
	exports.RouteHandler = exports.ActiveHandler;

	exports.HashLocation = __webpack_require__(205);
	exports.HistoryLocation = __webpack_require__(208);
	exports.RefreshLocation = __webpack_require__(209);
	exports.StaticLocation = __webpack_require__(210);
	exports.TestLocation = __webpack_require__(211);

	exports.ImitateBrowserBehavior = __webpack_require__(212);
	exports.ScrollToTopBehavior = __webpack_require__(213);

	exports.History = __webpack_require__(207);
	exports.Navigation = __webpack_require__(214);
	exports.State = __webpack_require__(215);

	exports.createRoute = __webpack_require__(191).createRoute;
	exports.createDefaultRoute = __webpack_require__(191).createDefaultRoute;
	exports.createNotFoundRoute = __webpack_require__(191).createNotFoundRoute;
	exports.createRedirect = __webpack_require__(191).createRedirect;
	exports.createRoutesFromReactChildren = __webpack_require__(216);

	exports.create = __webpack_require__(217);
	exports.run = __webpack_require__(226);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RouteHandler = __webpack_require__(199);
	var Route = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(7);
	var warning = __webpack_require__(15);
	var PathUtils = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var qs = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContextWrapper = __webpack_require__(200);
	var assign = __webpack_require__(13);
	var PropTypes = __webpack_require__(190);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HistoryLocation = __webpack_require__(208);
	var History = __webpack_require__(207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(13);
	var warning = __webpack_require__(15);
	var DefaultRoute = __webpack_require__(189);
	var NotFoundRoute = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var canUseDOM = __webpack_require__(51).canUseDOM;
	var LocationActions = __webpack_require__(206);
	var ImitateBrowserBehavior = __webpack_require__(212);
	var HashLocation = __webpack_require__(205);
	var HistoryLocation = __webpack_require__(208);
	var RefreshLocation = __webpack_require__(209);
	var StaticLocation = __webpack_require__(210);
	var ScrollHistory = __webpack_require__(218);
	var createRoutesFromReactChildren = __webpack_require__(216);
	var isReactChildren = __webpack_require__(220);
	var Transition = __webpack_require__(221);
	var PropTypes = __webpack_require__(190);
	var Redirect = __webpack_require__(223);
	var History = __webpack_require__(207);
	var Cancellation = __webpack_require__(222);
	var Match = __webpack_require__(224);
	var Route = __webpack_require__(191);
	var supportsHistory = __webpack_require__(225);
	var PathUtils = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createRouter = __webpack_require__(217);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsActionsMealActionsJs = __webpack_require__(228);

	var _jsComponentsMealsTableRowsJs = __webpack_require__(231);

	var _jsComponentsMealsTableRowsJs2 = _interopRequireDefault(_jsComponentsMealsTableRowsJs);

	var MealsTable = (function (_Component) {
		_inherits(MealsTable, _Component);

		function MealsTable(props) {
			_classCallCheck(this, MealsTable);

			_get(Object.getPrototypeOf(MealsTable.prototype), 'constructor', this).call(this, props);
		}

		_createClass(MealsTable, [{
			key: 'componentDidMount',
			value: function componentDidMount() {
				var dispatch = this.props.dispatch;

				dispatch((0, _jsActionsMealActionsJs.fetchMealsIfNeeded)('allMeals'));
			}
		}, {
			key: 'render',
			value: function render() {
				var mealsReducer = this.props.mealsReducer;
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(_jsComponentsMealsTableRowsJs2['default'], { meals: mealsReducer.get('allMeals').items.toJS() })
				);
			}
		}]);
	...
	MealsTable.propTypes = {
		mealsReducer: _react.PropTypes.instanceOf(_immutable2['default'].Map),
		dispatch: _react.PropTypes.func.isRequired
	};

	function mapStateToProps(state) {
		var mealsReducer = state.mealsReducer;

		return { mealsReducer: mealsReducer };
	}

	exports['default'] = (0, _reactRedux.connect)(mapStateToProps)(MealsTable);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchMealsIfNeeded = fetchMealsIfNeeded;
	...
	function requestMeals(requestType) {
	  return {
	    type: _jsConstantsConstants2['default'].REQUEST_MEALS,
	...
	function receiveMeals(requestType, details) {
	  return {
	    type: _jsConstantsConstants2['default'].RECEIVE_MEALS,
	    requestType: requestType,
	    details: details
	  };
	}
	...
	function fetchMeals(requestType) {
	  return function (dispatch) {
	    ...
	    if (requestType == 'allMeals') {
	      return (0, _isomorphicFetch2['default'])('http://localhost:8001/data/mockData.json').then(function (response) {
	        return response.json();
	      }).then(function (json) {
	        return dispatch(receiveMeals(requestType, json));
	      });
	    } else {
	      return (0, _isomorphicFetch2['default'])('http://localhost:8001/data/myMeals.json').then(function (response) {
	        return response.json();
	      }).then(function (json) {
	        return dispatch(receiveMeals(requestType, json));
	      });
	...
	function shouldFetchMeals(state, requestType) {
	  var meals = state.mealsReducer.get(requestType);
	  if (!meals.items.size) {
	    return true;
	...
	function fetchMealsIfNeeded(requestType) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsComponentsProfileImageJs = __webpack_require__(232);

	var _jsComponentsProfileImageJs2 = _interopRequireDefault(_jsComponentsProfileImageJs);

	var _jsComponentsRatingJs = __webpack_require__(233);

	var _jsComponentsRatingJs2 = _interopRequireDefault(_jsComponentsRatingJs);

	var _jsComponentsJoinButtonJs = __webpack_require__(235);

	var _jsComponentsJoinButtonJs2 = _interopRequireDefault(_jsComponentsJoinButtonJs);

	var _jsComponentsMealJs = __webpack_require__(236);

	var _jsComponentsMealJs2 = _interopRequireDefault(_jsComponentsMealJs);

	var MealsTableRows = (function (_Component) {
		_inherits(MealsTableRows, _Component);

		function MealsTableRows() {
			_classCallCheck(this, MealsTableRows);

			_get(Object.getPrototypeOf(MealsTableRows.prototype), 'constructor', this).apply(this, arguments);
		}

		_createClass(MealsTableRows, [{
			key: 'render',
			value: function render() {
				...
				var rows = this.props.meals.map(function (meal) {
					...
					return _react2['default'].createElement(
						'div',
						{ key: meal.id },
						_react2['default'].createElement(_jsComponentsMealJs2['default'], { meal: meal.meal }),
						_react2['default'].createElement(_jsComponentsJoinButtonJs2['default'], { joinStatus: meal.joinStatus })
					);
				});
		...
		return MealsTableRows;
	})(_react.Component);

	exports['default'] = MealsTableRows;

	MealsTableRows.propTypes = {
		meals: _react.PropTypes.array.isRequired
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProfileImage = (function (_Component) {
		_inherits(ProfileImage, _Component);

		function ProfileImage() {
			_classCallCheck(this, ProfileImage);

			_get(Object.getPrototypeOf(ProfileImage.prototype), 'constructor', this).apply(this, arguments);
		}

		_createClass(ProfileImage, [{
			key: 'render',
			value: function render() {
				var imgUrl = this.props.image || "defaulProfileImage.jpg";
				var profileImage = { backgroundImage: 'url(' + imgUrl + ')' };

				return _react2['default'].createElement('div', { style: profileImage });
			}
		}]);
	...
	var Rating = (function (_Component) {
		...
		_createClass(Rating, [{
			...
			value: function render() {
				...
				var ratings = (0, _classNames2['default'])({ oneStar: this.props.rating >= 1 }, { oneHalfStar: this.props.rating >= 1.4 && this.props.rating <= 1.6 }, { twoStar: this.props.rating >= 2 }, { twoHalfStar: this.props.rating >= 2.4 && this.props.rating <= 2.6 }, { threeStar: this.props.rating >= 3 }, { threeHalfStar: this.props.rating >= 3.4 && this.props.rating <= 3.6 }, { fourStar: this.props.rating >= 4 }, { fourHalfStar: this.props.rating >= 4.4 && this.props.rating <= 4.6 }, { fiveStar: this.props.rating >= 5 });

				return _react2['default'].createElement(
					'div',
					{ className: ratings },
					this.props.rating,
					_react2['default'].createElement('div', { className: 'rating-stars' }),
					_react2['default'].createElement('div', { className: 'rating-stars' }),
					_react2['default'].createElement('div', { className: 'rating-stars' }),
					_react2['default'].createElement('div', { className: 'rating-stars' }),
					_react2['default'].createElement('div', { className: 'rating-stars' })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var JoinButton = (function (_Component) {
		_inherits(JoinButton, _Component);

		function JoinButton() {
			_classCallCheck(this, JoinButton);

			_get(Object.getPrototypeOf(JoinButton.prototype), 'constructor', this).apply(this, arguments);
		}

		_createClass(JoinButton, [{
			key: 'render',
			value: function render() {

				var status = (0, _classNames2['default'])('joinButton', this.props.joinStatus);

				return _react2['default'].createElement('div', { className: status });
			}
		}]);
	...
	JoinButton.propTypes = {
		joinStatus: _react.PropTypes.string
	};
	module.exports = exports['default'];
			...
			value: function render() {
				...
				return _react2["default"].createElement(
					...
					_react2["default"].createElement(
						"div",
						{ className: "mealName" },
						this.props.meal.mealName
					),
					_react2["default"].createElement(
						"div",
						{ className: "servingSize" },
						this.props.meal.servingSize
					),
					_react2["default"].createElement(
						"div",
						{ className: "servingTime" },
						this.props.meal.servingTime
					),
					_react2["default"].createElement(
						"div",
						{ className: "cuisineType" },
						this.props.meal.cuisineType
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsActionsContactsActionsJs = __webpack_require__(238);

	var _jsComponentsContactsJs = __webpack_require__(239);

	var _jsComponentsContactsJs2 = _interopRequireDefault(_jsComponentsContactsJs);
	...
	var ContactsTable = (function (_Component) {
		...
		function ContactsTable(props) {
			...
			_get(Object.getPrototypeOf(ContactsTable.prototype), 'constructor', this).call(this, props);
		}
		...
		_createClass(ContactsTable, [{
			...
			value: function componentDidMount() {
				...
				dispatch((0, _jsActionsContactsActionsJs.fetchContactsIfNeeded)());
			}
		}, {
			key: 'render',
			value: function render() {
				var contactsReducer = this.props.contactsReducer;

				return _react2['default'].createElement(_jsComponentsContactsJs2['default'], { contacts: contactsReducer.get('contacts').toJS() });
			}
		}]);
	...
	exports.ContactsTable = ContactsTable;

	ContactsTable.propTypes = {
		contactsReducer: _react.PropTypes.instanceOf(_immutable2['default'].Map),
		dispatch: _react.PropTypes.func.isRequired
	};

	function mapStateToProps(state) {
		var contactsReducer = state.contactsReducer;

		return { contactsReducer: contactsReducer };
	}

	exports['default'] = (0, _reactRedux.connect)(mapStateToProps)(ContactsTable);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchContactsIfNeeded = fetchContactsIfNeeded;
	...
	function requestContacts() {
	  return {
	    type: _jsConstantsConstants2['default'].REQUEST_CONTACTS
	  };
	}

	function receiveContacts(details) {
	  return {
	    type: _jsConstantsConstants2['default'].RECEIVE_CONTACTS,
	    details: details
	  };
	}
	...
	function fetchContacts() {
	  return function (dispatch) {
	    ...
	    return (0, _isomorphicFetch2['default'])('http://localhost:8001/data/contactsData.json').then(function (response) {
	      return response.json();
	    }).then(function (json) {
	      return dispatch(receiveContacts(json));
	    });
	  };
	}

	function shouldFetchContacts(state) {
	  var reducer = state.contactsReducer;
	...
	function fetchContactsIfNeeded() {
	  return function (dispatch, getState) {
		...
		_createClass(Contacts, [{
			...
			value: function render() {
				...
				var contacts = this.props.contacts.map(function (contact) {
					return _react2['default'].createElement(
						'div',
						{ to: 'messagesTable', params: { chatId: contact.id }, key: contact.id },
						contact.name
					);
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsActionsMessagesActionsJs = __webpack_require__(241);

	var _jsComponentsMessagesJs = __webpack_require__(242);

	var _jsComponentsMessagesJs2 = _interopRequireDefault(_jsComponentsMessagesJs);

	var MessagesTable = (function (_Component) {
		_inherits(MessagesTable, _Component);

		function MessagesTable(props) {
			_classCallCheck(this, MessagesTable);

			_get(Object.getPrototypeOf(MessagesTable.prototype), 'constructor', this).call(this, props);
		}

		_createClass(MessagesTable, [{
			key: 'componentDidMount',
			value: function componentDidMount() {
				var dispatch = this.props.dispatch;

				dispatch((0, _jsActionsMessagesActionsJs.fetchMessagesIfNeeded)(999));
			}
		}, {
			key: 'render',
			value: function render() {
				var messagesReducer = this.props.messagesReducer;

				var contact = messagesReducer.get(999) || messagesReducer.get('noMessages');
				return _react2['default'].createElement(_jsComponentsMessagesJs2['default'], { messages: contact.messages.toJS() });
			}
		}]);
	...
	MessagesTable.propTypes = {
		messagesReducer: _react.PropTypes.instanceOf(_immutable2['default'].Map),
		dispatch: _react.PropTypes.func.isRequired
	};

	function mapStateToProps(state) {
		var messagesReducer = state.messagesReducer;

		return { messagesReducer: messagesReducer };
	}

	exports['default'] = (0, _reactRedux.connect)(mapStateToProps)(MessagesTable);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchMessagesIfNeeded = fetchMessagesIfNeeded;
	...
	function requestMessages(contactId) {
	  return {
	    type: _jsConstantsConstants2['default'].REQUEST_MESSAGES,
	    contactId: contactId
	  };
	}
	...
	function receiveMessages(contactId, details) {
	  return {
	    type: _jsConstantsConstants2['default'].RECEIVE_MESSAGES,
	    contactId: contactId,
	    details: details
	  };
	}
	...
	function fetchMessages(contactId) {
	  return function (dispatch) {
	    ...
	    return (0, _isomorphicFetch2['default'])('http://localhost:8001/data/messagesData.json').then(function (response) {
	      return response.json();
	    }).then(function (json) {
	      return dispatch(receiveMessages(contactId, json));
	    });
	  };
	}

	function shouldFetchMessages(state, contactId) {
	  var messagesForContact = state.messagesReducer.get(contactId);
	...
	function fetchMessagesIfNeeded(contactId) {
	  return function (dispatch, getState) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsActionsProfileActionsJs = __webpack_require__(244);
	...
	var MenuContainer = (function (_React$Component) {
		...
		_createClass(MenuContainer, [{
			...
			value: function componentDidMount() {
				...
				dispatch((0, _jsActionsProfileActionsJs.fetchProfileIfNeeded)(999));
			}
		}, {
			key: 'render',
			value: function render() {
				var _props = this.props;
				var profileReducer = _props.profileReducer;
				var menuReducer = _props.menuReducer;

				var profile = profileReducer.get(999) || profileReducer.get('emptyProfile');
				...
				return _react2['default'].createElement(
					'div',
					{ className: menuReducer.get('menuState') },
					_react2['default'].createElement(_jsComponentsProfileImageJs2['default'], { image: profile.data.get('image') })
				);
			}
		}]);
	...
	MenuContainer.propTypes = {
		menuState: _react.PropTypes.instanceOf(_immutable2['default'].Map),
		profileReducer: _react.PropTypes.instanceOf(_immutable2['default'].Map),
		dispatch: _react.PropTypes.func.isRequired
	};

	function mapStateToProps(state) {
		var menuReducer = state.menuReducer;
		var profileReducer = state.profileReducer;

		return { menuReducer: menuReducer, profileReducer: profileReducer };
	}

	exports['default'] = (0, _reactRedux.connect)(mapStateToProps)(MenuContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function requestProfile(profileId) {
	  return {
	    type: _jsConstantsConstants2['default'].REQUEST_PROFILE,
	    profileId: profileId
	  };
	}
	...
	function receiveProfile(profileId, details) {
	  return {
	    type: _jsConstantsConstants2['default'].RECEIVE_PROFILE,
	    profileId: profileId,
	    details: details
	  };
	}
	...
	function fetchProfile(profileId) {
	  return function (dispatch) {
	    ...
	    return (0, _isomorphicFetch2['default'])('http://localhost:8001/data/userData.json').then(function (response) {
	      return response.json();
	    }).then(function (json) {
	      return dispatch(receiveProfile(profileId, json));
	    });
	  };
	}

	function shouldFetchProfile(state, profileId) {
	  var profile = state.profileReducer.get(profileId);
	  if (!profile) {
	    return true;
	...
	function fetchProfileIfNeeded(profileId) {
	  return function (dispatch, getState) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsActionsMenuActionsJs = __webpack_require__(246);
	...
	var NavHeader = (function (_React$Component) {
		...
		_createClass(NavHeader, [{
			...
			value: function toggleMenu() {
				dispatch((0, _jsActionsMenuActionsJs.toggleMenu)());
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'div',
						{ className: 'navHamburger', onClick: this.toggleMenu },
						'nav hamburger here'
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function toggleMenu() {
	  return {
	    type: _jsConstantsConstants2['default'].TOGGLE_MENU
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/stylus-loader/index.js!./mixins.styl", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/stylus-loader/index.js!./mixins.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "-webkit-transform translate(x,\ny) {\n  transform: translate(x, y);\n}\nbody {\n  background-color: #00f;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/stylus-loader/index.js!./resets.styl", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/stylus-loader/index.js!./resets.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
